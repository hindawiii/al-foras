...
const STRINGS: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    // Currency hub
    currencyHubTitle: "مركز العملات والذهب",
    currencyHubSubtitle: "عملات عالمية ومحلية، الذهب، والعملات الرقمية في مكان واحد",
    ...
    goldPrice24K: "سعر الذهب (24K)",
    dataSourcesNote: "مصادر البيانات: open.er-api.com للعملات و CoinGecko للذهب والعملات الرقمية — تحديث تلقائي كل دقيقة.",
    currencyConverter: "محول العملات",
    goldCalculator: "حاسبة الذهب",
    resultLabel: "النتيجة",
    globalPrice: "السعر العالمي",
    localPrice: "السعر المحلي",
    localFormula: "السعر المحلي = العالمي × سعر صرف {x} الحي",
    weightG: "غ",
    weightGramsPlaceholder: "الوزن (غ)",
    guestNotice: "👋 أنت تستخدم التطبيق كضيف — سنضيف تسجيل الدخول قريبًا لحفظ بياناتك على السحابة.",
    guestEmail: "👤 ضيف",
    pickImage: "الرجاء اختيار صورة",
    imageTooLarge: "الصورة أكبر من 4 ميجابايت",
    uploadFailed: "تعذر رفع الصورة",
    saveImageFailed: "تعذر حفظ الصورة",
    photoUpdated: "تم تحديث صورتك",
    couldNotReadImage: "تعذر قراءة الصورة",
  },
  en: {
    settings: "Settings",
    darkMode: "Dark mode",
    ...
    // Currency hub
    currencyHubTitle: "Currency & Gold Hub",
    currencyHubSubtitle: "Global & local currencies, gold, and digital coins in one place",
    updatedAtLabel: "Updated",
    fiatCurrencies: "Fiat currencies",
    digitalCurrencies: "Digital currencies",
    priceVsUSD: "Price vs USD",
    livePrice: "Live price",
    goldPrice24K: "Gold price (24K)",
    dataSourcesNote: "Sources: open.er-api.com (rates) and CoinGecko (gold & crypto) — auto-refresh every minute.",
    currencyConverter: "Currency Converter",
    goldCalculator: "Gold Calculator",
    resultLabel: "Result",
    globalPrice: "Global price",
    localPrice: "Local price",
    localFormula: "Local price = global × live {x} exchange rate",
    weightG: "g",
    weightGramsPlaceholder: "Weight (g)",
    guestNotice: "👋 You're using the app as a guest — sign-in will return soon to sync your data to the cloud.",
    guestEmail: "👤 Guest",
    ...
    couldNotReadImage: "Couldn't read the image",
  },
};
